...
screen_clear()
print(f'''
    ___ _       __{gr}Xsamir{res}_    ______  __________ __ __________ {wh}
   /   | |     / / ___/   / ____/ / / / ____/ //_// ____/ __ \{red}
  / /| | | /| / /\__ \   / /_  / / / / /   / ,<  / __/ / /_/ /{ble}
 / ___ | |/ |/ /___/ /  / __/ / /_/ / /___/ /| |/ /___/ _, _/ {yl}
/_/  |_|__/|__//____/  /_/    \____/\____/_/ |_/_____/_/ |_|  {gr}
                                        {wh}           Xsamir {red}V2{res}
''')

link = input(f'{gr}Give Me Your Aws_Keys.txt{res}\{red}Xsamir> {gr}${res} ')
...
with open('Results/TryCreate.txt', 'r') as fp:
    for star in fp:
        ...
        try:
            ...
            pws = "Xproady55hmido#1ejeg2shehhe"
